  ...
  <main class="w-full flex flex-col h-full">
    <div class="search-bar-section p-4 border-b border-b-gray-300">
      ...
      <div class='property-list flex-grow bg-gray-200 flex flex-col px-2'>
          <template v-if='properties.propertiesLoading'>
              <div class='mx-auto text-center mt-12 flex'>
          ...
          <template v-else>
              <p class='text-center text-lg p-2 mt-4'>
                  <template v-if='!search.length'> Hier erscheinen deine Immobilien, sobald du welche angelegt hast.
                  </template>
