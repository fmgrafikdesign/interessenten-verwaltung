...
;    text: 'Immobilie gespeichert!'
  "Immobilie gespeichert!"e>
  ;<d;iv class="property-view w-full flex flex-col h-full">
    ...
    <div class="property-content flex-grow bg-gray-200 flex flex-col px-2 pt-4">
      <template v-if="property">
        ...
        <div class="remove-property-button-wrapper mx-auto">
          <button @click="removeProperty" class="w-auto inline-block mb-8 underline text-red-500">
            Immobilie löschen
          </button>
        </div>
      </template>
